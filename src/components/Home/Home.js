    ...
    return (
        <div className='body d-flex align-items-center justify-content-center'>
            <div>
                ...
                <Button className='mt-5 d-flex align-items-center' variant="success"><Link to='/courses' className='text-white text-decoration-none'><h4 className='m-2'>Get Start <FaArrowRight/></h4></Link></Button>
            </div>
        </div>
    );
};
